 ...
 flutterTts.setSpeechRate(0.93);
  ...
  Future checkFirstSeen() async {
    ...
    if (_seen3) {
      ...
      _speak(
          'مرحبًا بك في صفحة، المعلومات العامة.  في هذه الصفحة ستجد عدة نصوصٍ من كتبٍ مختلفة، لِتَسْتَمِعَ اِليْها. إلَيْكَ كيف تستعملها.  النصوص متوفرة في شَاشَتِكَ مِثل البطاقات. لِلْتَنَقُّلِ مِنْ نصٍّ اِلى اَخَرْ، قُمْ بِالسَّحْبِ أُفُقِيًّا مرَّةً على حدا و سنقرأ لك عنوان النص الموافِق. لإختيار نص، يكفي ان تَنْقُرَ على الشاشة مرَّةً واحدة و ستبدأ قراءة النص. يمكنك التسريع الى الامام عبر السَّحْبِ اِلى الاََسْفَلْ اَو العودة الى الوراء عبر السَّحْبِ اِلى الاَعلى. لِايقاف القِرَائَةِ يَكفي اَن تَنْقُرَ مَرَّةً ثَانِيَةً عَلى الشاشة. و طبعاً كَكُلِّ مَرَّةٍ اِذَا نسيت اَيَّ شيئٍ هُزَّ الهاتف و سنذكرك');
